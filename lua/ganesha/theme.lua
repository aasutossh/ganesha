...
local c = require('ganesha.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "WinBar", { fg = '#ff0000', bg = '#000000' })
  ...
  hl(0, "TabLineSel", { fg = c.base00, bg = c.pmenu_bg })
  ...
  hl(0, "@tag.attribute", { fg = 'NONE', bg = 'NONE', italic=true, })
  ...
  hl(0, "DiagnosticVirtualTextHint", { fg = c.purple, bg = '#1d0e2d' })
  hl(0, "DiagnosticVirtualTextInfo", { fg = c.sun, bg = '#2b200d' })
  hl(0, "DiagnosticVirtualTextWarn", { fg = c.base09, bg = '#200d05' })
  hl(0, "DiagnosticVirtualTextError", { fg = c.base08, bg = '#26061d' })
